...
\newpage
\datedsubsection{\textbf{Sylar 高性能服务器框架复现与 WebSocket IM 系统}}{2025.06 -- 2025.10}
\textbf{技术栈：}C++17, Linux, Epoll, Reactor, 协程, Hook, Socket/TCP, WebSocket, Redis, MySQL

\textbf{项目描述：}复现 Sylar 高性能服务器框架的核心模块，并基于该框架开发 WebSocket IM 系统，验证协程化网络框架在长连接业务中的应用。

\textbf{项目亮点：}
\begin{itemize}
	\item 基于 C++17 复现 Sylar 核心架构，采用 \textbf{Epoll ET} 实现 IO 多路复用，完成协程调度器、IOManager、定时器及 Socket/TCP 等网络模块。
